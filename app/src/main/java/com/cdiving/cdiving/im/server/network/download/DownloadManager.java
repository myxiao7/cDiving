...
package com.cdiving.cdiving.im.server.network.download;
...
import com.cdiving.cdiving.im.server.network.http.AsyncHttpClient;
import com.cdiving.cdiving.im.server.network.http.AsyncHttpResponseHandler;
import com.cdiving.cdiving.im.server.network.http.BreakpointHttpResponseHandler;

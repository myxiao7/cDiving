...
import com.cdiving.cdiving.utils.constant.RegexConstants;
...
public final class RegexUtils {
     ...
     * @return
     */
    public static boolean isVerifyCode(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_VERIFY_CODE, input);
    }
